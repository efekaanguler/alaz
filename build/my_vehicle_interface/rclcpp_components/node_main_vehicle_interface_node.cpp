...
#define NODE_MAIN_LOGGER_NAME "vehicle_interface_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmy_vehicle_interface_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<my_vehicle_interface::VehicleInterfaceNode>";
