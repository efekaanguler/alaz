...
class TrafficLightClassifierNode(Node):
    ...
    def _classify_with_hsv(self, crop: np.ndarray) -> Tuple[str, float]:
        ...
        # Tight thresholds to avoid false-red from skin/warm walls
        # TL classifier receives CROPPED images — should be mostly TL housing
        red_1 = cv2.inRange(hsv, (0, 130, 120), (10, 255, 255))
        red_2 = cv2.inRange(hsv, (165, 130, 120), (180, 255, 255))
